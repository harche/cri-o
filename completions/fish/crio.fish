...
complete -c crio -n '__fish_crio_no_subcommand' -f -l evented-pleg -d 'Whether CRI-O should generate the container events in order to optimize the performance of Kubelet to rely on these events'
